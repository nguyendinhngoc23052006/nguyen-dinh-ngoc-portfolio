...
export const projects: Project[] = [
  {
    ...
    tags: ["Astro", "React islands", "Tailwind", "URL state", "Cloudflare Pages"],
    status: "shipped",
  ...
  },
  {
    ...
    tags: ["React", "TypeScript", "GSAP ScrollTrigger", "Lenis", "i18n", "Cloudflare Pages"],
    status: "shipped",
    url: "https://nguyen-le-khanh-portfolio.pages.dev",
    source: "https://github.com/nguyendinhngoc23052006/nguyen-le-khanh-portfolio",
  },
  {
    num: "03",
    title: "regex tester",
